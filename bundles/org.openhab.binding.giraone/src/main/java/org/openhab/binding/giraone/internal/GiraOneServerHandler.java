    ...
    public void initialize() {
        ...
        scheduler.execute(() -> {
            ...
            if (thingReachable) {
                ...
                Channel channel = ChannelBuilder.create(new ChannelUID(getThing().getUID(), "hallo#12"), "itemType")
                        .withType(new ChannelTypeUID("giraa", "233")).withLabel("label").withDescription("description")
                        .withKind(ChannelKind.STATE).build();
                getThing().getChannels().add(channel);
            } else {
