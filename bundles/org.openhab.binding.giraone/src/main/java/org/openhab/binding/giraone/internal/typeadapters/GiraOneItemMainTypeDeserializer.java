...
/**
 * Deserializes a Json Element to {@link GiraOneItemMainType} within context of Gson parsing.
 *
...
public class GiraOneItemMainTypeDeserializer implements JsonDeserializer<GiraOneItemMainType> {
    ...
    @Override
    @Nullable
    public GiraOneItemMainType deserialize(@Nullable JsonElement jsonElement, @Nullable Type type,
        ...
        if (jsonElement != null) {
            try {
                ...
                logger.warn("Cannot map '{}' into enum of {}", jsonElement.getAsString(),
                        GiraOneItemMainType.class.getName());
            }
        }
